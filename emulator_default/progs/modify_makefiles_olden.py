...
"""
    ...
    all_targets = ["$(TARGET_NOATOM_RISCV)"]
    if has_noatom:
        #all_targets.extend(["$(TARGET_RISCV)", "$(TARGET_ZCU_RISCV)"])
        all_targets.extend(["$(TARGET_RISCV)"])
...
"""
    ...
    clean_targets = ["*.o", "$(TARGET_NOATOM_RISCV)"]
    if has_noatom:
        #clean_targets.extend(["$(TARGET_RISCV)", "$(TARGET_ZCU_RISCV)"])
        clean_targets.extend(["$(TARGET_RISCV)"])
