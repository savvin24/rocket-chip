...
int main() {
    ...
    #ifndef NOATOM 
        atom_map((void*) head, sizeof(Node)/(1<<GRANULARITY)+1, 21);
    #endif
    ...
    #ifndef NOATOM
        atom_map((void*) current_ptr, sizeof(Node)/(1<<GRANULARITY)+1, 256); 
        atom_define(21, 0, (void*) current_ptr); // Define the atom with the current pointer
    #endif
    ...
    #ifndef NOATOM
        atom_map((void*) current_ptr, sizeof(Node)/(1<<GRANULARITY)+1, 1050); 
        atom_define(256, 0, (void*) current_ptr); // Define the atom with the current pointer
    #endif
    ...
    #ifndef NOATOM
        atom_map((void*) current_ptr, sizeof(Node)/(1<<GRANULARITY)+1, 2047); 
        atom_define(1050, 0, (void*) current_ptr); // Define the atom with the current pointer
    #endif
    ...
    #ifndef NOATOM
        atom_define(2047, 0, (void*) current_ptr); // Define the atom with the current pointer
    #endif
