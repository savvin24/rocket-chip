...
int main() {
    ...
    #ifndef NOATOM
        atom_map((void*) current_ptr, sizeof(Node)/(1<<GRANULARITY)+1, 7); 
        atom_define(6, 0, (void*) current_ptr); // Define the atom with the current pointer
    #endif
    ...
    insert(data);
        ...
        atom_define(7, 0, (void*) current_ptr); // Define the atom with the current pointer
    #endif
