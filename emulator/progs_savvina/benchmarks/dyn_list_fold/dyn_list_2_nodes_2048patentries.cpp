...
int main() {
    ...
    #ifndef NOATOM 
        atom_map((void*) head, sizeof(Node)/(1<<GRANULARITY)+1, 2046);
    #endif
    ...
    #ifndef NOATOM
        atom_map((void*) current_ptr, sizeof(Node)/(1<<GRANULARITY)+1, 5);
        atom_define(2046, 0, (void *) current_ptr); // Define the atom with the current pointer
    #endif
